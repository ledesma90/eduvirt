...
//============================================================================================================================================
class Proyectos_x_personas extends CI_Controller {
...
//============================================================================================================================================
       var $tabla1 = [0=>[
                ...
                "elementos_form" =>  [
                    ...
                    'dimension_input' => '6',
                    'style' => "text-align: left; width: 100%;",
                    'select_dato' => 'select p.id_proyecto as id, i.nombre||\' - \'||p.nombre as valor from proyectos p inner join instituciones i on (p.id_institucion=i.id_institucion)',//puede ser una array o un select de la base de datos
                    'select_default' => '',//coloca el valor por default en el select
                    'data-select' => '',//activar buscador en el select quitar el '-no' para activar en el nombre,
                    'required' => ''
                    ]
...
//============================================================================================================================================
            ...
            $estructura = [
                ...
                "titulo_general" => "Proyectos por personas",
