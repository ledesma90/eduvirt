...
//============================================================================================================================================
    var $nombres_config=array('tabla1','tabla2','tabla3','tabla34','tabla4','tabla5','tabla6','tabla7','tabla8','tabla9','tabla10');
//============================================================================================================================================
...
//============================================================================================================================================
       var $tabla1 = [0=>[
                ...
                "select" => [
                    "id_usuario","nombre","apellido","ruc","documento_identidad","email","genero","to_char(fecha_nacimiento,'dd/mm/yyyy') as fecha_nacimiento","(select estado from usuarios where usuarios.id_usuario=personas.id_usuario) as estado","get_user_nombre(id_usuario) as usuario"
                ],
                "calculado" =>  [
                ...
                "hijos" => ["usuarios","roles_x_usuarios","telefonos","direcciones","topicos","documento_informativo","cursos","cursos_inscriptos","proyectos_x_personas","contactos"],//hijos de esta tabla para la lectura automatica al seleccionar
                'fila' => 'ini',
                'columna' => 'ini',
                'dimension_tabla' => '8',
       ...
       var $tabla3 = [0=>[
           ...
           var $tabla34 = [0=>[
                ...
                "where" => "id_usuario = :1 order by id_doc desc",
                "lectura_where_variables" => [':1' =>['id_usuario','P']],//P significa que busca la variable del padre
                "lectura_inicial" => "N",//S significa que lee del principio, caso contrario espera que se apriete el boton de leer
                "action" => ['visible'=>'S','opciones' =>['S','S','S','S']],//activar el boton de accion||insertar||mofificar||borrar||leer
                "tipo_actualizacion" => "update",//delete/insert or update
           ...
           var $tabla6 = [0=>[
                ...
                "where" => "proyectos_x_personas.id_usuario=:1",
                "lectura_where_variables" => [':1' =>['id_usuario','P']],//P significa que busca la variable del padre
                "lectura_inicial" => "N",//S significa que lee del principio, caso contrario espera que se apriete el boton de leer
                "action" => ['visible'=>'S','opciones' =>['S','S','S','S']],//activar el boton de accion||insertar||mofificar||borrar||leer
                "tipo_actualizacion" => "update",//delete/insert or update
