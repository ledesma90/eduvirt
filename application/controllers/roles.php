	...
	{   
            foreach ($this->nombres_config as $value) {
                ...
                //if ($this->config($this->$value,'configname')[0]['update_table']==$this->input->post('tipo',true)){
                    ...
                    $array_mensaje=$this->config($this->tabla1,'sqlmanual',array("update contactos set nuevo_mensaje=1 where id_usuario=".$this->input->post('contacto',true)." and contacto=".$this->input->post('contacto',true)));
