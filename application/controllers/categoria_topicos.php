...
//============================================================================================================================================
class Categoria_topicos extends CI_Controller {
...
//============================================================================================================================================
       var $tabla1 = [0=>[
                ...
                "select" => [
                    "id_categoria","categoria","categoria_grupo","descripcion","orden","get_count_topicos_categoria(id_categoria) as cantidad_topicos","get_count_comentarios_categoria(id_categoria) as cantidad_comentarios","get_ultimo_topico(id_categoria) as ultimo_topico"
                ],
                "calculado" =>  [
                ...
                "update_table" => "categoria_topicos",
                "join" => "categoria_topicos",
                "where" => "",
