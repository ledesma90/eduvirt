...
//============================================================================================================================================
       var $tabla1 = [0=>[
                ...
                "select" => [
                    "id_comentario","id_usuario","id_topico","comentario_persona","imagen ", "usuario", "fecha_formato", "info_boton", "info_comentario", "es_usuario"
                ],
                "calculado" =>  [
                ...
                "columnas_actualizables" =>  [
                    "id_usuario","id_topico","comentario_persona"
                ],
                ...
                "update_table" => "comentarios",
                "join" => "pr_comentario_info",
...
//============================================================================================================================================
	...
	{   
            ...
            $exite_favorito=$this->config($this->tabla1,'sqlmanual',array("select count(1) as contador from favoritos_topicos where id_usuario=".$this->session->userdata('id_usuario')." and id_topico=".substr($this->uri->segment(3),5).""));
...
//============================================================================================================================================
        ...
        public function borrardatos()
	{
            foreach ($this->nombres_config as $value) {
                ...
                if ($this->config($this->$value,'configname')[0]['update_table']==$this->input->post('tipo',true)){
                    ...
                    $array_mensaje=$this->config($this->tabla1,'sqlmanual',array("delete from comentarios where id_usuario=".$this->session->userdata('id_usuario')." and id_comentario=".$this->input->post('id_comentario',true).""));
                    
                    echo $this->input->post('id_comentario',true);
	...
	{   
            //foreach ($this->nombres_config as $value) {
                ...
                //if ($this->config($this->$value,'configname')[0]['update_table']==$this->input->post('tipo',true)){
                    ...
                    $array_mensaje=$this->config($this->tabla1,'sqlmanual',array("insert into valoraciones_comentarios (id_usuario,id_comentario) values (".$this->session->userdata('id_usuario').",".$this->input->post('id_comentario',true).")"));
                    
                    echo $array_mensaje;
                    }  else {
                    $array_mensaje=$this->config($this->tabla1,'sqlmanual',array("delete from valoraciones_comentarios where id_usuario=".$this->session->userdata('id_usuario')." and id_comentario=".$this->input->post('id_comentario',true).""));
	...
	{   
            //foreach ($this->nombres_config as $value) {
                ...
                //if ($this->config($this->$value,'configname')[0]['update_table']==$this->input->post('tipo',true)){
                    ...
                    $array_mensaje=$this->config($this->tabla1,'sqlmanual',array("insert into favoritos_topicos (id_usuario,id_topico) values (".$this->session->userdata('id_usuario').",".$this->input->post('id_topico',true).")"));
                    
                    echo $array_mensaje;
                    }  else {
                    $array_mensaje=$this->config($this->tabla1,'sqlmanual',array("delete from favoritos_topicos where id_usuario=".$this->session->userdata('id_usuario')." and id_topico=".$this->input->post('id_topico',true).""));
        ...
        public function get_info_comentario()
	{
            ...
            select get_info_comentario('.$this->input->post('id_comentario',true).') as comen');
            $row = $query2->row();
