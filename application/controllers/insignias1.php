...
//============================================================================================================================================
            $estructura = [
                ...
                "titulo_tabla" => "ABM de Insignias",
                "titulo_general" => "Insignias",
...
//============================================================================================================================================
            ...
            $this->load->view('insignias/formulario_modal',["dato" => $this->config('configname')]);
...
//============================================================================================================================================
            $this->load->view('insignias/funciones',["dato" => $this->config('configname'),"segmento" => base_url().$this->router->fetch_class().'/']);
//============================================================================================================================================
