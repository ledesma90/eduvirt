...
//============================================================================================================================================
class Cursos_categoria extends CI_Controller {
...
//============================================================================================================================================
       var $tabla1 = [0=>[
                ...
                "update_table" => "cursos_categoria",
                "join" => "cursos_categoria",
                "where" => "",
                ...
                'columna' => 'ini-fin',
                'dimension_tabla' => '4',
                'titulo' => 'Categoria de los Cursos',
...
//============================================================================================================================================
            ...
            $estructura = [
                ...
                "titulo_general" => "Categoria de los Cursos",
