...
//============================================================================================================================================
       var $tabla1 = [0=>[
                ...
                "update_table" => "tests",
                "join" => "tests",
                "where" => "id_test=:id_test and estado='A'",
                ...
                "action" => ['visible'=>'N','opciones' =>['N','N','N','S']],//activar el boton de accion||insertar||mofificar||borrar||leer
...
//============================================================================================================================================
            ...
            $estructura = [
                ...
                "titulo_general" => "Creacion de Examenes",
...
//============================================================================================================================================
            ...
            //echo var_dump($this->config($this->$value,'configname'));
            //$this->load->view($this->router->fetch_class().'/funciones_'.$this->$value[0]['update_table'],["dato" => $this->config($this->$value,'configname'),"segmento" => base_url().$this->router->fetch_class().'/',"segmento_acortado" => base_url()]);
	}
        ...
        public function ejecucion_primaria()
	{
            ...
            if (in_array(1,$pila)) {
                $this->tabla3[0]['action']['visible']='S';
            };
            if (in_array(3,$pila)) {
                $this->tabla3[0]['action']['visible']='S';
            };
