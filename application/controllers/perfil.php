...
//============================================================================================================================================
    var $nombres_config=array('tabla1','tabla5','tabla56','tabla6','tabla7','tabla8','tabla9','tabla10','tabla11','tabla12');
//============================================================================================================================================
...
//============================================================================================================================================
       var $tabla1 = [0=>[
                ...
                "select" => [
                    "id_usuario","nombre","apellido","ruc","documento_identidad","email","genero","fecha_nacimiento","educacion","habilidades","info", "user_nombre", "imagen","ubicacion","count_contactos","es_contacto", "pr_insignia_cursos(id_usuario) as insignaia_curso"
                ],
                "calculado" =>  [
           ...
           var $tabla56 = [0=>[
                //los arrays (select y calculado) deben ser igualmente proporcional a las columnoas configuradas en la datatable
                "select" => [
                    "id_doc","id_usuario","id_categoria","topic","tema","get_usuario_nombre(id_usuario) as nombre_usuario", "get_valoracion_informativo(id_doc) as valoracion","get_count_comentarios(id_doc) as cantidad_respuestas","get_ultimo_guia(id_doc) as ultimo_comentario"
                ],
                "calculado" =>  [
                ...
                "elementos_form" =>  [
                    ...
                    'dimension_input' => '6',
                    'style' => "text-align: left; width: 100%;",
                    'select_dato' => 'select id_categoria as id, categoria as valor from categoria_informativo',//puede ser una array o un select de la base de datos
                    'select_default' => '',//coloca el valor por default en el select
                    'data-select' => '',//activar buscador en el select quitar el '-no' para activar en el nombre,
                    'required' => ''
                    ],
                ...
                "update_table" => "documento_informativo",
                "join" => "documento_informativo",
                "where" => "id_usuario = :id_usuario order by id_doc desc",
                "lectura_where_variables" => ['' =>['','']],//P significa que busca la variable del padre
                "lectura_inicial" => "S",//S significa que lee del principio, caso contrario espera que se apriete el boton de leer
           ...
           var $tabla7 = [0=>[
                //los arrays (select y calculado) deben ser igualmente proporcional a las columnoas configuradas en la datatable
                "select" => [
                    "cursos.id_curso", "nombre", "cursos.id_usuario", "estado", "duracion", "descripcion", "categoria", "finalizado", "(select nombre from cursos_categoria where id_categoria=cursos.categoria) as nombre_categoria", "COALESCE(to_char(fecha_ini, 'dd/mm/yyyy')) as fecha_ini", "COALESCE(to_char(fecha_fin, 'dd/mm/yyyy')) as fecha_fin"
                ],
                "calculado" =>  [
...
//============================================================================================================================================
            ...
            $estructura = [
                ...
                "titulo_general" => "Perfil del Usuario",
	...
	{   
            foreach ($this->nombres_config as $value) {
                ...
                if ($this->config($this->$value,'configname')[0]['update_table']==$this->input->post('tipo',true)){
                    ...
                    if ('personas'==$this->input->post('tipo',true)){
                        $new_param=array_merge($this->input->post('parametros'),[':id_user' =>$this->session->userdata('id_usuario')]);
                        echo $this->config($this->$value,'result',  $this->funciones->strReplaceAssoc_from($new_param,$this->{$value}[0]['where']));
                    }else{
                        $new_param=$this->input->post('parametros');
	...
	{   
            //foreach ($this->nombres_config as $value) {
                ...
                //if ($this->config($this->$value,'configname')[0]['update_table']==$this->input->post('tipo',true)){
                    ...
                    if ($this->input->post('opcion',true)=='<b>Agregar Contacto</b>'){
                    ...
                    $array_mensaje=$this->config($this->tabla1,'sqlmanual',array("delete from contactos where id_usuario=".$this->session->userdata('id_usuario')." and contacto=".$this->input->post('id_contacto',true).""));
