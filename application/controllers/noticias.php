...
//============================================================================================================================================
       var $tabla1 = [0=>[
                ...
                "select" => [
                    "id_noticia", "noticias.id_usuario as id_usuario", "titulo", "descripcion", "noticias.estado", "id_categoria", "foto","encode(imagen, 'base64') as imagen ", "usuarios.usuario as usuario", "COALESCE(to_char(fecha_hora, 'dd/mm/yyyy HH24:MI:SS')) as fecha_formato", "get_valoracion_noticia(id_noticia,:user) as info_boton", "get_info_noticia(id_noticia) as info_noticia"
                ],
                "calculado" =>  [
                ...
                "columnas_actualizables" =>  [
                    "id_usuario", "titulo","descripcion", "estado", "id_categoria"
                ],
                ...
                "elementos_form" =>  [
                    ...
                    'dimension_input' => '6',
                    'style' => "text-align: left; width: 100%;",
                    'select_dato' => 'select id_categoria as id, nombre as valor from noticias_categoria',//puede ser una array o un select de la base de datos
                    'select_default' => '',//coloca el valor por default en el select
                    'data-select' => '',//activar buscador en el select quitar el '-no' para activar en el nombre,
                    'required' => ''
                    ]
                ...
                "where" => "(:categoria>0 and id_categoria=:categoria) or (:categoria=0 and (id_categoria>0 or id_categoria is null))  order by id_noticia desc",
                "lectura_where_variables" => [':categoria' =>['','E']],//P significa que busca la variable del padre
...
//============================================================================================================================================
           $pila=$this->ejecucion_primaria();
            ...
            <div class="row">
                ...
                <div class="col-xs-6">      
                    <select id="noticiascategoria" class="form-control" style="width: 100%;">
...
//============================================================================================================================================
        ...
        public function axtis()
	{
            ...
            $var_aux=json_encode($this->config($this->tabla1,'sqlmanual',array("select id_categoria as id,nombre as text, 'false' as disabled from noticias_categoria "
