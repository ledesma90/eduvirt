...
$( "#grabar_dato_<?= $dato[0]['update_table'] ?>" ).click(function() {
    ...
    var parametros_grabar = {
        ...
        parametros  :{  1:id, 
                        2: $( "#<?= $dato[0]['update_table'] ?>pais" ).val(), 
                        3: $( "#<?= $dato[0]['update_table'] ?>gentilicio" ).val() 
                    }};
  $.ajax({
    method: "POST",
...
//============================================================================================================================================
        "columns": [
            { "data": "id_pais","visible": true,"searchable": true,"sTitle": "Id"/*,"sWidth": "30%"*/ },
            { "data": "nombre","visible": true,"searchable": true,"sTitle": "Nombre"/*,"sWidth": "30%"*/ },
            { "data": "gentilicio","visible": true,"searchable": true,"sTitle": "Gentilicio"/*,"sWidth": "30%"*/ }
        ]
//============================================================================================================================================
// FIN                                                                                                                                       4
//============================================================================================================================================
...
//============================================================================================================================================
    $('#insertar<?= $dato[0]['update_table'] ?>').click( function () {
        $( "#<?= $dato[0]['update_table'] ?>pais" ).val('');
        $( "#<?= $dato[0]['update_table'] ?>gentilicio" ).val('');
    ...
    $('#modificar<?= $dato[0]['update_table'] ?>').click( function () {
            try {
                $( "#<?= $dato[0]['update_table'] ?>pais" ).val(<?= $dato[0]['update_table'] ?>.row('.selected').data().nombre);
                $( "#<?= $dato[0]['update_table'] ?>gentilicio" ).val(<?= $dato[0]['update_table'] ?>.row('.selected').data().gentilicio);
                $( "#grabar_marco_<?= $dato[0]['update_table'] ?>" ).show();
                $( "#borrar_marco_<?= $dato[0]['update_table'] ?>" ).hide();
                $("#myModal_<?= $dato[0]['update_table'] ?>").modal();
            }
