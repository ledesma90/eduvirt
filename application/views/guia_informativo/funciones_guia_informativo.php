...
//============================================================================================================================================
        "columns": [
            { "data": "id_guia","visible": true,"searchable": false,"sTitle": "Id","className": "arriba_datos"/*,"sWidth": "30%"*/ },
            { "data": "id_usuario","visible": false,"searchable": false,"sTitle": "Usuario","sWidth": "10%" },
            { "data": "id_doc","visible": false,"searchable": false,"sTitle": "Topic"/*,"sWidth": "30%"*/ },
        ...
        "columnDefs": [
           ...
           <button onclick="borrarregistro('+row.id_guia+')" type="button" class="btn btn-default btn-xs">Eliminar</button>';
                    } else {
                        $( "#guia_info1" ).hide();
                    }
              l_data+='\n\
...
//============================================================================================================================================
 ...
 //============================================================================================================================================
    ...
    function opciones_valoracion(objeto,id_guia){
        
        $.ajax({
        method: "POST",
        url: '<?= $segmento ?>opciones_valoracion',
        data: {'id_guia':id_guia,'opcion':objeto.innerHTML}
      })
        .done(function( msg ) {
          //alert( "Data Saved: " + msg );
    ...
    function get_info_comentario(id_guia){
        ...
        .done(function( msg ) {
          //alert( "Data Saved: " + msg );
            ...
            $('#info_comentario'+id_guia).html(msg.trim());
    ...
    function opciones_favorito(objeto){
        ...
        data: {'id_doc':$(location).attr('href').split( '/' )[5].substr(5),'opcion':objeto.innerHTML}
      })
        .done(function( msg ) {
          //alert( "Data Saved: " + msg );
