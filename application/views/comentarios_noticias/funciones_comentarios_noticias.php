...
var <?= $dato[0]['update_table'] ?>id_noticia=$(location).attr('href').split( '/' )[5];

    var <?= $dato[0]['update_table'] ?>comentario = CKEDITOR.replace("<?= $dato[0]['update_table'] ?>comentario", {
    });
...
//============================================================================================================================================
        "columns": [
            { "data": "id_comentario_noticia","visible": false,"searchable": false,"sTitle": "Id","sWidth": "70%" },
            { "data": "id_noticia","visible": false,"searchable": false,"sTitle": "Curso"/*,"sWidth": "30%"*/ },
            { "data": "id_usuario","visible": false,"searchable": false,"sTitle": "Grupo","sWidth": "10%" },
            { "data": "comentario","visible": false,"searchable": true,"sTitle": "Numero de la clase"/*,"sWidth": "30%"*/ },
            { "data": "fecha_hora","visible": true,"searchable": true,"sTitle": "Nombre de la clase"/*,"sWidth": "30%"*/ },
            { "data": "user_nombre","visible": false,"searchable": true,"sTitle": "Grupo","sWidth": "10%" },
            { "data": "fecha_formato","visible": false,"searchable": true,"sTitle": "Numero de la clase"/*,"sWidth": "30%"*/ },
            { "data": "imagen","visible": false,"searchable": false,"sTitle": "Nombre de la clase"/*,"sWidth": "30%"*/ },
        ],
//============================================================================================================================================
// FIN                                                                                                                                       4
//============================================================================================================================================
        "columnDefs": [
            {
                ...
                "render" : function( data, type, row, meta ) {
                  ...
                  <div class="direct-chat-info clearfix"> \n\
                    <span class="direct-chat-name pull-right">'+row.user_nombre+'</span>\n\
...
//============================================================================================================================================
    ...
    $('#<?= $dato[0]['update_table'] ?> tbody').on( 'click', 'tr', function () {
        if ( $(this).hasClass('selected') ) {
            ...
            <?php
            echo "if (".$dato[0]['update_table'].".row('.selected').data().id_usuario==".$id_usuario."){ $( '#borrar".$dato[0]['update_table']."' ).show(); $( '#modificar".$dato[0]['update_table']."' ).show();}";
            echo "if (".$dato[0]['update_table'].".row('.selected').data().id_usuario!=".$id_usuario."){ $( '#borrar".$dato[0]['update_table']."' ).hide(); $( '#modificar".$dato[0]['update_table']."' ).hide();}";
            ?>
...
//============================================================================================================================================
    ...
    <?php if($dato[0]['action']['opciones'][0]=='S'){ ?>
        ...
        <?= $dato[0]['update_table'] ?>.$('tr.selected').removeClass('selected');
            ...
            CKEDITOR.instances.<?= $dato[0]['update_table'] ?>comentario.setData("");
            $( "#<?= $dato[0]['update_table'] ?>id_noticia").val(<?= $dato[0]['update_table'] ?>id_noticia);
    ...
    <?php if($dato[0]['action']['opciones'][1]=='S'){ ?>   
        $('#modificar<?= $dato[0]['update_table'] ?>').click( function () {
                try {
                    ...
                    ?>
                    CKEDITOR.instances.<?= $dato[0]['update_table'] ?>comentario.setData(<?= $dato[0]['update_table'] ?>.row('.selected').data().<?= $dato[0]['columnas_actualizables'][2] ?>);
                    $( "#<?= $dato[0]['update_table'] ?>id_noticia").val(<?= $dato[0]['update_table'] ?>id_noticia);
                    $( "#grabar_marco_<?= $dato[0]['update_table'] ?>" ).show();
                    $( "#borrar_marco_<?= $dato[0]['update_table'] ?>" ).hide();
                    $("#myModal_<?= $dato[0]['update_table'] ?>").modal();
