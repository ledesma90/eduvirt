...
function leer<?= $dato[0]['update_table'] ?>() {
       ...
       $cadena_parametros='';
        ...
        ?>
            ...
            var id_curso=$(location).attr('href').split( '/' )[5];
...
//============================================================================================================================================
        "columns": [
            { "data": "id_usuario","visible": true,"searchable": true,"sTitle": "Participantes","sWidth": "5%" },
        ...
        "columnDefs": [
            {
                ...
                "render" : function( data, type, row ) {
                  ...
                  return '<div class="direct-chat-msg right"> \n\
                    ...
                    <a href="http://www.eduvirt.com/perfil/index/'+data+'" >\n\
