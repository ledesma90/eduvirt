...
//============================================================================================================================================
        "columns": [
            ...
            { "data": "count_comentarios","visible": false,"searchable": true,"sTitle": "Usuario","className": "colmanas_numeros","sWidth": "10%" },
        ],
        "columnDefs": [
            {
                "targets": [ 0 ], 
            ...
            <div class="box-footer no-padding">\n\
              <ul class="nav nav-stacked">\n\
                ...
                <li><a href="#">Comentarios <span class="pull-right badge bg-aqua">'+row.count_comentarios+'</span></a></li>\n\
