        ...
        "columnDefs": [
            {
                ...
                "render" : function( data, type, row, meta ) {
                    ...
                    <!-- /.direct-chat-info -->\n\
                    <a onclick="fn_validad_examen('+row.id_test+')" >\n\
...
//============================================================================================================================================
    ...
    function fn_validad_examen(id_test){
    
        $.ajax({
        method: "POST",
        url: '<?= $segmento ?>existe_examen_por_rendir',
        data: {'id_test':id_test,'id_curso':$(location).attr('href').split( '/' )[5]}
      })
        .done(function( response ) {

                    if (response.trim()=='S'){
                        location.href ="http://www.eduvirt.com/test/index/"+id_test;
                    }
                    if (response.trim()=='N'){
                        alert('No puede rendir este examen todavia');
                    }
