...
var <?= $dato[0]['update_table'] ?>id_curso=$(location).attr('href').split( '/' )[5];
    ...
    var <?= $dato[0]['update_table'] ?>comentario_persona = CKEDITOR.replace("<?= $dato[0]['update_table'] ?>comentario_persona", {
...
//============================================================================================================================================
        "columns": [
            { "data": "id_comentario","visible": false,"searchable": false,"sTitle": "Id","sWidth": "70%" },
            { "data": "id_curso","visible": false,"searchable": false,"sTitle": "Curso"/*,"sWidth": "30%"*/ },
            { "data": "id_usuario","visible": false,"searchable": false,"sTitle": "Grupo","sWidth": "10%" },
            { "data": "fecha_hora","visible": false,"searchable": true,"sTitle": "Numero de la clase"/*,"sWidth": "30%"*/ },
            { "data": "comentario_persona","visible": true,"searchable": true,"sTitle": "Nombre de la clase"/*,"sWidth": "30%"*/ },
...
//============================================================================================================================================
    ...
    <?php if($dato[0]['action']['opciones'][0]=='S'){ ?>
        ...
        <?= $dato[0]['update_table'] ?>.$('tr.selected').removeClass('selected');
            ...
            CKEDITOR.instances.<?= $dato[0]['update_table'] ?>comentario_persona.setData("");
    ...
    <?php if($dato[0]['action']['opciones'][1]=='S'){ ?>   
        $('#modificar<?= $dato[0]['update_table'] ?>').click( function () {
                try {
                    ...
                    ?>
                    CKEDITOR.instances.<?= $dato[0]['update_table'] ?>comentario_persona.setData(<?= $dato[0]['update_table'] ?>.row('.selected').data().<?= $dato[0]['columnas_actualizables'][2] ?>);
                    $( "#grabar_marco_<?= $dato[0]['update_table'] ?>" ).show();
                    $( "#borrar_marco_<?= $dato[0]['update_table'] ?>" ).hide();
                    $("#myModal_<?= $dato[0]['update_table'] ?>").modal();
                    $( "#borrar_marco_<?= $dato[0]['update_table'] ?>" ).hide();
