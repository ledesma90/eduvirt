            ...
            console.log(JSON.parse(response)[0].cantidad_topicos_out);
              ...
              function drawChart() {
                var data = google.visualization.arrayToDataTable([
                  ['Datos', 'Topicos creados', 'Topicos valorados', 'Total comentarios en todos mis topicos', 'Maximo de comentario en un topico mio', 'Comentarios valorados en mis topicos', 'Mis comentarios valorados en los topicos', 'Mis topicos favoritos de los mios', 'Todos mis topicos favoritos'],
                  ['Hasta la fecha', Number(structura.cantidad_topicos_out), Number(structura.topicos_valorados_out), Number(structura.total_comentarios_out), Number(structura.max_comentarios_out), Number(structura.comentarios_valorados_out), Number(structura.mis_comentarios_valorados_out), Number(structura.topicos_favoritos_out), Number(structura.mis_topicos_favoritos_out)]
                ]);

                var options = {
                  chart: {
                    title: 'Estadistica de mis Topicos',
                    subtitle: 'Son datos exclusivamente de mis topicos creados',
                  }
                };
...
//============================================================================================================================================
        "columns": [
            { "data": "id_usuario","visible": true,"searchable": true,"sTitle": "Id","sWidth": "5%","className": "colmanas_numeros" },
            { "data": "usuario","visible": false,"searchable": true,"sTitle": "Usuario"/*,"sWidth": "30%"*/ },
            { "data": "password","visible": false,"searchable": false,"sTitle": "Password"/*,"sWidth": "30%"*/ },
            { "data": "estado","visible": false,"searchable": true,"sTitle": "Estado"/*,"sWidth": "30%"*/ },
            { "data": "imagen","visible": false,"searchable": true,"sTitle": "Imagen"/*,"sWidth": "30%"*/ },
        ],
        "columnDefs": [
            {
                "targets": [ 0 ], 
                "render" : function( data, type, row ) {
                    ...
                    if (row.estado=='A'){
                        ...
                        <div class="widget-user-header bg-aqua-active">\n\
                          ...
                          <!-- /.widget-user-image -->\n\
                          <h3 class="widget-user-username">'+row.usuario+'</h3>\n\
                          <h4 class="widget-user-username">'+l_estado+'</h4>\n\
                        </div>\n\
                        <div class="box-footer no-padding">\n\
                          <ul class="nav nav-stacked">\n\
                            <li>\n\
                            <form enctype="multipart/form-data" action="<?= $segmento ?>grabarimagen" method="POST">\n\
