...
//============================================================================================================================================
    ...
    .done(function( msg ) {
      if (msg.trim()!=''){
          window.location.href='<?= $segmento_acortado ?>guia_informativo/index/topic'+msg.trim()+'/';
          //alert( msg.trim() );
      }
...
function leer<?= $dato[0]['update_table'] ?>() { 
       ...
       $cadena_parametros='';
        ...
        ?>
            ...
            var idcategoria=$(location).attr('href').split( '/' )[5];
...
//============================================================================================================================================
        "columns": [
            { "data": "id_doc","visible": false,"searchable": true,"sTitle": "Id","sWidth": "95%" },
            ...
            { "data": "topic","visible": true,"searchable": true,"sTitle": "Recursos"/*,"sWidth": "30%"*/ },
            ...
            { "data": "cantidad_respuestas","visible": false,"searchable": true,"sTitle": "Respuestas","sWidth": "5%" },
            { "data": "ultimo_comentario","visible": true,"searchable": true,"sTitle": "Elaborado por","sWidth": "5%" },
        ],
        "columnDefs": [
            {
                "targets": [ 3 ], 
                "render" : function( data, type, row, meta ) {
                    if (data==null){
                        ...
                        return '<h5><a href="<?= $segmento_acortado ?>guia_informativo/index/topic'+row.id_doc+'/" style="text-decoration:none">'+row.topic+'</a><small> '+row.tema+'</small></h5>\n\
...
//============================================================================================================================================
    ...
    <?php if($dato[0]['action']['opciones'][0]=='S'){ ?>
        ...
        <?= $dato[0]['update_table'] ?>.$('tr.selected').removeClass('selected');
            ...
            $('#documento_informativoid_categoria').select2({placeholder: "Selecciona"}).val($(location).attr('href').split( '/' )[5]).trigger('change');
        } );
    <?php } ?>
