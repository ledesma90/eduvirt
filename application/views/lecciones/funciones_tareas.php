...
var <?= $dato[0]['update_table'] ?>id_clase=$(location).attr('href').split( '/' )[5];
var dueno_curso;
...
//============================================================================================================================================
        "columns": [
            { "data": "id_tarea","visible": true,"searchable": true,"sTitle": "Id","sWidth": "5%" },
            { "data": "id_usuario","visible": false,"searchable": true,"sTitle": "Nombre","sWidth": "20%" },
            { "data": "id_clase","visible": false,"searchable": true,"sTitle": "Apellido","sWidth": "20%" },
            { "data": "comentario","visible": false,"searchable": true,"sTitle": "C.I.","className": "colmanas_numeros","sWidth": "10%" },
            { "data": "tarea","visible": false,"searchable": true,"sTitle": "Ruc","className": "colmanas_numeros","sWidth": "10%" },
            { "data": "fecha_hora","visible": false,"searchable": true,"sTitle": "Email","sWidth": "20%" },
            { "data": "user_nombre","visible": false,"searchable": true,"sTitle": "Ruc","className": "colmanas_numeros","sWidth": "10%" },
            { "data": "fecha_formato","visible": false,"searchable": true,"sTitle": "C.I.","className": "colmanas_numeros","sWidth": "10%" },
            { "data": "imagen","visible": false,"searchable": true,"sTitle": "Email","sWidth": "20%" },
            { "data": "nota","visible": false,"searchable": true,"sTitle": "Email","sWidth": "20%" },
        ...
        "columnDefs": [
            {
                ...
                "render" : function( data, type, row, meta ) {
                  ...
                  <div class="direct-chat-info clearfix"> \n\
                    <span class="direct-chat-name pull-right">'+nota+''+row.user_nombre+'</span>\n\
                    <span class="direct-chat-timestamp pull-left">'+row.fecha_formato+'</span>\n\
                  </div>\n\
                  <!-- /.direct-chat-info -->\n\
...
//============================================================================================================================================
    ...
    <?php if($dato[0]['action']['opciones'][0]=='S'){ ?>
        ...
        <?= $dato[0]['update_table'] ?>.$('tr.selected').removeClass('selected');
            ...
            ?>
            $( "#<?= $dato[0]['update_table'] ?>id_clase").val(<?= $dato[0]['update_table'] ?>id_clase);    
...
//============================================================================================================================================
      ...
      $.ajax({
        ...
        // DATOS A PASAR LA INSERCION DEL REGISTRO O MODIFICAION DEL MISMO SI EXISTE LA CLAVE PRIMARIA                                               1
        //============================================================================================================================================
            data: {'id_clase':<?= $dato[0]['update_table'] ?>id_clase}
        //============================================================================================================================================
        // FIN                                                                                                                                       1
        //============================================================================================================================================
          })
            .done(function( msg ) {
                if (msg.trim()=='S'){
                    dueno_curso='S';
                    <?php
                    echo "$( '#modificartareas' ).show();";
                    ?>
                }
                else{
                    dueno_curso='N';
                <?php
                echo "$( '#modificartareas' ).hide();";
                ?>
                }
          });
...
$('#subir_tarea').click( function () {
        ...
        $.ajax({
        method: "POST",
        url: '<?= $segmento ?>verificar_subida',
        data: {'id_clase':$(location).attr('href').split( '/' )[5]}
      })
        .done(function( response ) {
        
                    if (response.trim()=='S'){
                        location.href ="http://www.eduvirt.com/tareas";
                    }
                    if (response.trim()=='N'){
                        if (dueno_curso=='S'){
                        location.href ="http://www.eduvirt.com/tareas";
                        }else{
                        alert('No puede subir un Archivo, no existe una prorroga de entrega de tarea');
                        }
                    }
