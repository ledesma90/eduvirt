...
var <?= $dato[0]['update_table'] ?>id_clase=$(location).attr('href').split( '/' )[5];
    ...
    var <?= $dato[0]['update_table'] ?>contenido = CKEDITOR.replace("<?= $dato[0]['update_table'] ?>contenido", {
        toolbarGroups: [
...
//============================================================================================================================================
        "columns": [
            { "data": "id_leccion","visible": true,"searchable": true,"sTitle": "Id","sWidth": "70%" },
            { "data": "contenido","visible": false,"searchable": true,"sTitle": "Contenido"/*,"sWidth": "30%"*/ },
            { "data": "id_clase","visible": false,"searchable": true,"sTitle": "Clase","sWidth": "10%" },
            { "data": "titulo","visible": false,"searchable": true,"sTitle": "Titulo","sWidth": "10%" },
        ],
//============================================================================================================================================
// FIN                                                                                                                                       4
//============================================================================================================================================
    ...
    <td colspan="1"><span style="padding-left: 5px;"></span></td>\n\
</tr>'
                    );
                ...
                $.each(val,function(index2,val2){
                        ...
                        if (typeof titulo[groupid] =='undefined'){
                            titulo[groupid] = new Array();
                        }
                        if (typeof titulo[groupid][index2] =='undefined'){
                            titulo[groupid][index2] = 0;
                        }
                        
                        titulo[groupid][index2] = val2;
            ...
            $('tbody').find('.group').each(function (i,v) {
        		...
        		$(this).find('td:first').append($('<span />', { 'class': 'rowCount-grid' }).append($('<b />', { 'text': ' '+titulo[i]['titulo']+'' })));
         ...
         "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
                ...
                $('td:eq(0)', nRow).attr('style','width:900px');
                return nRow;
          }
    } );
...
//============================================================================================================================================
    ...
    <?php if($dato[0]['action']['opciones'][0]=='S'){ ?>
        ...
        <?= $dato[0]['update_table'] ?>.$('tr.selected').removeClass('selected');
            ...
            ?>
            CKEDITOR.instances.<?= $dato[0]['update_table'] ?>contenido.setData("");
    ...
    <?php if($dato[0]['action']['opciones'][1]=='S'){ ?>   
        $('#modificar<?= $dato[0]['update_table'] ?>').click( function () {
                try {
                    ...
                    $( "#leccionesid_clase" ).val(lecciones.row('.selected').data().id_clase);
                    $( "#leccionestitulo" ).val(lecciones.row('.selected').data().titulo);   
                    CKEDITOR.instances.<?= $dato[0]['update_table'] ?>contenido.setData(<?= $dato[0]['update_table'] ?>.row('.selected').data().<?= $dato[0]['columnas_actualizables'][0] ?>);
                    $( "#grabar_marco_<?= $dato[0]['update_table'] ?>" ).show();
                    $( "#borrar_marco_<?= $dato[0]['update_table'] ?>" ).hide();
                    $("#myModal_<?= $dato[0]['update_table'] ?>").modal();
                    $( "#borrar_marco_<?= $dato[0]['update_table'] ?>" ).hide();
        ...
        //============================================================================================================================================
            ...
            .done(function( msg ) {
                if (msg.trim()=='S'){
                    ...
                    echo "$( '#opciontareas_tutor' ).show();";
                    ?>
                }else{
                    <?php
                    echo "$( '#opcion".$dato[0]['update_table']."' ).hide();";
                    echo "$( '#opciontareas_tutor' ).hide();";
                    ?>
                }
                <?php
                echo "$( '#opciontareas' ).show();";
                ?>
          });
