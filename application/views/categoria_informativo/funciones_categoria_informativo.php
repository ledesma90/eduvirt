...
//============================================================================================================================================
        "columns": [
            ...
            { "data": "cantidad_topicos","visible": true,"searchable": true,"sTitle": "Cantidad de Guias","sWidth": "10%" },
            { "data": "cantidad_comentarios","visible": false,"searchable": false,"sTitle": "Cantidad de Comentarios","sWidth": "10%" },
            { "data": "ultimo_topico","visible": true,"searchable": true,"sTitle": "Ultima Guia","sWidth": "10%" },
        ],
//============================================================================================================================================
// FIN                                                                                                                                       4
//============================================================================================================================================
        "columnDefs": [
            {
                ...
                "render" : function( data, type, row, meta ) {
                    if (data==null){
                        ...
                        return '<h5><a href="<?= $segmento_acortado ?>documento_informativo/index/'+row.id_categoria+'" style="text-decoration:none">'+row.categoria+'</a></h5>\n\
    ...
    <td colspan="1"><h6 style="padding-left: 5px;text-align: center;">Guias</h6></td>\n\
    <td colspan="1"><h6 style="padding-left: 5px;text-align: center;">Ultima Guia</h6></td>\n\
</tr>'
                    );
