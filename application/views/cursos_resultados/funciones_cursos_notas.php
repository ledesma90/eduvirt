...
//============================================================================================================================================
        "columns": [
            { "data": "id_curso_out","visible": false,"searchable": true,"sTitle": "Curso","sWidth": "5%" },
            { "data": "nombre_out","visible": true,"searchable": true,"sTitle": "Curso","sWidth": "5%" },
            { "data": "examenes_total_puntos_out","visible": true,"searchable": true,"sTitle": "Examen","sWidth": "20%","className": "colmanas_numeros" },
            { "data": "examenes_out","visible": true,"searchable": true,"sTitle": "Logrado","sWidth": "20%","className": "colmanas_numeros" },
            { "data": "tareas_total_puntos_out","visible": true,"searchable": true,"sTitle": "Tareas","sWidth": "5%","className": "colmanas_numeros" },
            { "data": "tareas_out","visible": true,"searchable": true,"sTitle": "Logrado","sWidth": "20%","className": "colmanas_numeros" },
            { "data": "total_puntos_curso_out","visible": true,"searchable": true,"sTitle": "Total puntos","sWidth": "20%","className": "colmanas_numeros" },
            { "data": "total_puntos_alumno_out","visible": true,"searchable": true,"sTitle": "Logrado","sWidth": "20%","className": "colmanas_numeros" },
            { "data": "porcentaje_out","visible": true,"searchable": true,"sTitle": "Porcentaje","sWidth": "20%","className": "colmanas_numeros" },
            { "data": "fecha_fin_curso","visible": false,"searchable": false,"sTitle": "fecha","sWidth": "20%","className": "colmanas_numeros" },
            { "data": "nombre_persona","visible": false,"searchable": false,"sTitle": "persona","sWidth": "20%","className": "colmanas_numeros" },
            { "data": "vali_fecha","visible": false,"searchable": false,"sTitle": "persona","sWidth": "20%","className": "colmanas_numeros" },            
            { 
        ...
        "columnDefs": [
            {
                ...
                "render" : function( data, type, row ) {
                    ...
                    switch (true) {
                        ...
                        return '<span class="pull-right badge bg-'+l_color+'">Nota:('+l_nota+') '+row.porcentaje_out+'%</span>';
                  }
            ...
            },
            {
                ...
                "render" : function( data, type, row ) {
                    ...
                    if (l_nota>1){
                        if (row.vali_fecha=='S'){
                            return '<a href="#" onclick="post(\''+'/certificado/'+'\', {nombre: \''+row.nombre_persona+'\',curso: \''+row.nombre_out+'\', nota: \''+row.porcentaje_out+'%'+' Nota:('+l_nota+') '+'\', fecha: \''+row.fecha_fin_curso+'\'});return false;">Descargar</a>';
                        }
                        else{
                            return '';
                        }
