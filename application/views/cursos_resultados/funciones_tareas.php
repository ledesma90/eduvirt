...
//============================================================================================================================================
        "columns": [
            { "data": "nombre_clase","visible": false,"searchable": true,"sTitle": "Id","sWidth": "5%" },
            { "data": "contenido","visible": true,"searchable": true,"sTitle": "Descripción"/*,"sWidth": "30%"*/ },
            { "data": "puntaje","visible": true,"searchable": false,"sTitle": "Puntaje","className": "colmanas_numeros"/*,"sWidth": "30%"*/ },
            { "data": "nota","visible": true,"searchable": false,"sTitle": "Puntos","className": "colmanas_numeros"/*,"sWidth": "30%"*/ },
            { "data": "tarea","visible": true,"searchable": false,"sTitle": "Archivo"/*,"sWidth": "30%"*/ },
            { "data": "comentario","visible": true,"searchable": true,"sTitle": "Comentario"/*,"sWidth": "30%"*/ },
        ]
//============================================================================================================================================
// FIN                                                                                                                                       4
//============================================================================================================================================
    ...
    <?php if($dato[0]['action']['opciones'][0]=='S'){ ?>
        ...
        <?= $dato[0]['update_table'] ?>.$('tr.selected').removeClass('selected');
            ...
            if ($value==$dato[0]['padre'][1]){
                echo "if(".$dato[0]['padre'][0].".rows('.selected').count()==0){
        alert('Seleccione una ciudad para cargar un barrio');
        }";
