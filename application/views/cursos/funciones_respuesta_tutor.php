...
//============================================================================================================================================
        "columns": [
            { "data": "respuesta_tutor","visible": false,"searchable": false,"sTitle": "Id","sWidth": "70%" },
            ...
            { "data": "respuesta","visible": true,"searchable": false,"sTitle": "Respuesta","sWidth": "10%" },
            { "data": "nombre_respuesta","visible": true,"searchable": true,"sTitle": "Nombre"/*,"sWidth": "30%"*/ },
            { "data": "puntos","visible": true,"searchable": true,"sTitle": "Puntos"/*,"sWidth": "30%"*/ },
        ],
//============================================================================================================================================
// FIN                                                                                                                                       4
//============================================================================================================================================
...
function corregir_examen(){
        var id_test=0;
        try {
          id_test=tests.row('.selected').data().id_test;
        }
        catch(error) {
        ...
        if (id_test>0){
            ...
            $.ajax({
                method: "POST",
                url: '<?= $segmento ?>corregir_examen',
                data: {'id_test':id_test}
              })
                .done(function( msg ) {
                  alert( "El examen ha sido corregido" );
              });
        
        }
        else{
            
            alert('Debe selecionar una preba antes de corregir');
