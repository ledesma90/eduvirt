...
//============================================================================================================================================
        "columns": [
            { "data": "id_categoria","visible": true,"searchable": true,"sTitle": "Id","sWidth": "70%" },
            { "data": "categoria","visible": false,"searchable": true,"sTitle": "Categoria"/*,"sWidth": "30%"*/ },
            { "data": "categoria_grupo","visible": false,"searchable": true,"sTitle": "Grupo"/*,"sWidth": "30%"*/ },
            { "data": "descripcion","visible": false,"searchable": true,"sTitle": "Descipción"/*,"sWidth": "30%"*/ },
            { "data": "orden","visible": false,"searchable": true,"sTitle": "Orden"/*,"sWidth": "30%"*/ },
            { "data": "cantidad_topicos","visible": true,"searchable": true,"sTitle": "Cantidad de Topicos","sWidth": "10%" },
            { "data": "cantidad_comentarios","visible": true,"searchable": true,"sTitle": "Cantidad de Comentarios","sWidth": "10%" },
            { "data": "ultimo_topico","visible": true,"searchable": true,"sTitle": "Ultimo Topico","sWidth": "10%" },
        ],
//============================================================================================================================================
// FIN                                                                                                                                       4
//============================================================================================================================================
        "columnDefs": [
            {
                ...
                "render" : function( data, type, row, meta ) {
                    if (data==null){
                        ...
                        return '<h5><a href="<?= $segmento_acortado ?>topicos/index/'+row.id_categoria+'" style="text-decoration:none">'+row.categoria+'</a></h5>\n\
                                <h6 class="text-muted">'+row.descripcion+'</h6>';
    ...
    <td colspan="1"><h6 style="padding-left: 5px;">'+group+'</h6></td>\n\
    <td colspan="1"><h6 style="padding-left: 5px;text-align: center;">Topicos</h6></td>\n\
    <td colspan="1"><h6 style="padding-left: 5px;text-align: center;">Comentarios</h6></td>\n\
    <td colspan="1"><h6 style="padding-left: 5px;text-align: center;">Ultimo Topico</h6></td>\n\
</tr>'
                    );
