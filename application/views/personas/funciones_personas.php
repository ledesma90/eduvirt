...
//============================================================================================================================================
        "columns": [
            { "data": "id_usuario","visible": true,"searchable": true,"sTitle": "Estado","sWidth": "5%" },
            ...
            { "data": "ruc","visible": true,"searchable": true,"sTitle": "Ruc","className": "colmanas_numeros","sWidth": "10%" },
            { "data": "documento_identidad","visible": true,"searchable": true,"sTitle": "C.I.","className": "colmanas_numeros","sWidth": "10%" },
            ...
            { "data": "fecha_nacimiento","visible": true,"searchable": true,"sTitle": "F. Nac.","className": "colmanas_numeros","sWidth": "10%" },
            { "data": "estado","visible": false,"searchable": true,"sTitle": "F. Nac.","className": "colmanas_numeros","sWidth": "10%" },
            { "data": "usuario","visible": true,"searchable": true,"sTitle": "Usuario","sWidth": "10%" },
        ],
        "columnDefs": [
            {
                "targets": [ 0 ], 
                "render" : function( data, type, row, meta ) {
                    var l_estado='';
                    if (row.estado==='A'){
                        l_estado='<span class="pull-right badge bg-green">Activo</span>';
                    }else if(row.estado==='I'){
                        l_estado='<span class="pull-right badge bg-red">Inactivo</span>';
                    }
