...
<head>
  ...
  <title>Eduvirt | Pagina de Registro</title>
...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="registro/result" method="post">
      ...
      <div class="form-group has-feedback">
        <select id="personasgenero" name="genero" class="form-control" maxlength="1" style="text-align: left; width: 100%;" data-select="">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" name="check" > Acpeto los <a href="#">terminos</a>
            </label>
          </div>
        </div>
        <!-- /.col -->
