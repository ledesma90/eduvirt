...
//============================================================================================================================================
        "columns": [
            { "data": "id_curso","visible": false,"searchable": true,"sTitle": "Id","sWidth": "5%","className": "colmanas_numeros" },
            { "data": "nombre","visible": true,"searchable": true,"sTitle": "Nombre","sWidth": "25%" },
            { "data": "id_usuario","visible": false,"searchable": true,"sTitle": "Usuario","sWidth": "0%" },
            { "data": "estado","visible": true,"searchable": true,"sTitle": "Estado","sWidth": "10%" },
            { "data": "duracion","visible": true,"searchable": true,"sTitle": "Duracición","sWidth": "30%" },
            { "data": "descripcion","visible": true,"searchable": true,"sTitle": "Descripción","sWidth": "30%" },
            { "data": "categoria","visible": true,"searchable": true,"sTitle": "Categoria","sWidth": "30%" },
            { "data": "finalizado","visible": true,"searchable": true,"sTitle": "Finalizado","sWidth": "30%" },
            { "data": "nombre_categoria","visible": false,"searchable": true,"sTitle": "Finalizado","sWidth": "30%" },
            { "data": "fecha_ini","visible": true,"searchable": true,"sTitle": "Fecha Ini","sWidth": "30%" },
            { "data": "fecha_fin","visible": true,"searchable": true,"sTitle": "Fecha Fin","sWidth": "30%" },
        ],
        "columnDefs": [
            {
                "targets": [ 1 ], 
                "render" : function( data, type, row, meta ) {
                        ...
                        return '<a href="http://www.eduvirt.com/cursos_x_clases/index/'+row.id_curso+'">'+data+'</a>';
                  }
            ...
            },
            {
                ...
                "render" : function( data, type, row, meta ) {
                        if (data=='1'){
                            return '<span class="pull-right badge bg-red">'+(data>0? 'Finalizado':'En Curso')+'</span>';
                        }
                    
                        return '<span class="pull-right badge bg-green">'+(data>0? 'Finalizado':'En Curso')+'</span>';
                  }
